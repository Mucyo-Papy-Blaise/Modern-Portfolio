...
import { FaSearch,FaCamera,FaPaintBrush,FaPalette, FaBoxes,FaTwitter,FaLinkedin } from "react-icons/fa";
...
const CountUp: React.FC<CountUpProps> = ({ end, duration = 1000, isHovered }) => {
  ...
  React.useEffect(() => {
    if (isHovered) {
      setCount(0); // Reset the count when hover starts
      startCounting();
    } else {
  ...
  return (
    <div className="w-full min-h-screen bg-[#111111] pb-10">
      ...
      <div className="grid grid-cols-12 gap-4 pt-8 px-32 max-w-[1400px] mx-auto">
        <div className="bg-[#1A1A1A] rounded-2xl p-6 col-span-6 flex flex-row gap-4 w-full h-[200px] font-poppins 
        transform transition-all duration-300 hover:scale-[1.02] hover:bg-[#242424] cursor-pointer opacity-0 translate-y-10 animate-slideUp">
          ...
          <div className="flex flex-col mt-4">
            <p className="text-gray-400 mb-2 text-xs text-[13px]">A WEB DESIGNER</p>
        ...
        <div className="grid grid-cols-2 gap-4 w-full col-span-6">
          {/*  More About Me*/}
          <div className="bg-[#1A1A1A] rounded-3xl p-6 flex items-center justify-between w-full h-[200px] font-poppins
          ...
          <div className="bg-[#1A1A1A] rounded-3xl p-6 flex items-center justify-between w-full h-[200px] 
          transform transition-all duration-300 hover:scale-[1.02] hover:bg-[#242424] cursor-pointer group opacity-0 translate-y-10 animate-slideUp">
            <div >
              <img
                src={projectImg}
        ...
        {/* Blog Card */}
        <div className="bg-[#1A1A1A] rounded-2xl p-6 col-span-3 flex flex-row gap-4 w-full h-[200px] font-poppins 
        transform transition-all duration-300 hover:scale-[1.02] hover:bg-[#242424] cursor-pointer group opacity-0 translate-y-10 animate-slideUp">
          ...
          <div className="w-12 h-12 bg-[#393939] rounded-full flex items-center justify-center ml-20">
            <span className="text-2xl text-white">+</span>
          </div>
          </div>
        </div>
      ...
      {/* Service Offering */}
        ...
        transform transition-all duration-300 hover:scale-[1.02] hover:bg-[#242424] cursor-pointer group opacity-0 translate-y-10 animate-slideUp">
          ...
          <div className="flex flex-col">
            ...
            <FaCamera className="transform transition-all duration-300 hover:scale-125 hover:text-[#ffc86b]"/>
            <FaPaintBrush className="transform transition-all duration-300 hover:scale-125 hover:text-[#ffc86b]"/>
            <FaPalette className="transform transition-all duration-300 hover:scale-125 hover:text-[#ffc86b]"/>
            <FaBoxes className={`transform transition-all duration-300 hover:scale-125 hover:text-[#ffc86b]`}/>
            </div>
            <p className="text-gray-400 text-[13px]">SPECIALIZATION</p>
            <h2 className="text-xl text-white font-normal">Service Offering</h2>
          </div>
          <div className="w-12 h-12 bg-[#393939] rounded-full flex items-center justify-center ml-[125px]">
            <span className="text-2xl text-white">+</span>
          </div>
          </div>
        </div>
      ...
      {[
        ...
        >
          <p className="text-white font-semibold text-[30px] text-center">
            +<CountUp end={item.end} duration={1000} isHovered={hoveredIndex === index} />
          </p>
        ...
        transform transition-all duration-300 hover:scale-[1.02] hover:bg-[#242424] cursor-pointer group opacity-0 translate-y-10 animate-slideUp">
          ...
          <img src="" alt="" />
          <p className="text-[30px] text-white">Let's <br />Work <span className="text-[#ffc86b]">Together</span></p>
          </div>
        </div>
      </div>
      ...
      <footer className="flex flex-col justify-center items-center pt-16 font-poppins opacity-0 translate-y-10 animate-slideUp">
        ...
        <p className="text-sm text-white">
         &copy; {new Date().getFullYear()} All Right Reserved By <span className="text-[#]">Mucyo Papy Blaise</span>
        </p>
      </footer>
    </div>
  );
